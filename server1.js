...
jsonexport(outputData,function(err, csv){
    ...
    console.log("Hurray !! output generated .. Please goto output -> output1.csv to check the results")
});

})

function rangeCheck(dataSet,totalSize){ // to check if the data falls under the range for the partner
